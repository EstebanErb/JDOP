            ...
            <div class="SearchTravel">
                ...
                <select name="TypePlante" type="text" style="height:36px;" value="">
					...
					<?php foreach ($filtre as $p) { ?>
							<option value=<?php echo $p["TypePlante"]?>> <?php echo $p["TypePlante"]?> </option>
					<?php } ?>                    
                </select>
            ...
            <tbody>
                    <tr>
                        <th>
                            ...
                            <strong><?php echo $p["NomLatin"] ?></strong><br>
                            <strong><?php echo $p["NomPlante"] ?></strong><br>
                            <br>
                            <?php if(isset($p["CouleurFleur"])){ ?>
                                <strong>Couleur de la fleur : </strong><?php echo $p["CouleurFleur"] ?> <br> <?php ;
                                    }
                                    else{
                                        echo "";
                                    } ?>
                            ...
                            <?php if(isset($p["CouleurFeuillage"])){ ?>
                                <strong>Couleur du feuillage : </strong><?php echo $p["CouleurFeuillage"] ?> <br> <?php ;
                                    }
                                    else{
                                        echo "";
                                    } ?>
...
<!--                            <?php if(isset($p["Hauteur"])){ ?>
                            ...
                            <?php if(isset($p["Floraison"])){ ?>
                                <strong>Floraison : </strong><?php echo $p["Floraison"] ?> <br> <?php ;
                                    }
                                    else{
                                        echo "";
                                    } ?>
                            ...
                            <?php if(isset($p["TypeFeuillage"])){ ?>
                                <strong>Type de feuillage: </strong><?php echo $p["TypeFeuillage"] ?> <br> <?php ;
                                    }
                                    else{
                                        echo "";
                                    } ?>
                            ...
                            <?php if(isset($p["Exposition"])){ ?>
                                <strong>Exposition: </strong><?php echo $p["Exposition"] ?> <br> <?php ;
                                    }
                                    else{
                                        echo "";
                                    } ?>
                            ...
                            <?php if(isset($p["TypeSol"])){ ?>
                                <strong>Type de sol : </strong><?php echo $p["TypeSol"] ?> <br> <?php ;
                                    }
                                    else{
                                        echo "";
                                    } ?>
                            ...
                            <?php if(isset($p["Silhouette"])){ ?>
                                <strong>Silhouette : </strong><?php echo $p["Silhouette"] ?> <br> <?php ;
                                    }
                                    else{
                                        echo "";
                                    } ?>
                            ...
                            <?php if(isset($p["Densite"])){ ?>
                                <strong>Densité : </strong><?php echo $p["Densite"] ?> <br> <?php ;
                                    }
                                    else{
                                        echo "";
                                    } ?>
                            ...
                            <?php if(isset($p["Rusticite"])){ ?>
                                <strong>Rusticite : </strong><?php echo $p["Rusticite"] ?> <br> <?php ;
                                    }
                                    else{
                                        echo "";
                                    } ?>
                            ...
                            <?php if(isset($p["Utilisation"])){ ?>
                                <strong>Utilisation : </strong><?php echo $p["Utilisation"] ?> <br> <?php ;
                                    }
                                    else{
                                        echo "";
                                    } ?>
                            ...
                            <?php if(isset($p["Entretien"])){ ?>
                                <strong>Entretien : </strong><?php echo $p["Entretien"] ?> <br> <?php ;
                                    }
                                    else{
                                        echo "";
                                    } ?>
                            ...
                            <?php if(isset($p["PetitMoins"])){ ?>
                                <strong>Petit - : </strong><?php echo $p["PetitMoins"] ?> <br> <?php ;
                                    }
                                    else{
                                        echo "";
                                    } ?>
                            ...
                            <?php if(isset($p["PetitPlus"])){ ?>
                                <strong>Petit + : </strong><?php echo $p["PetitPlus"] ?> <br> <?php ;
                                    }
                                    else{
                                        echo "";
                                    } ?>
                        ...
                        <th>
                            ...
                            <strong><?php echo $p["NomLatin"] ?></strong><br>
                            <strong><?php echo $p["NomPlante"] ?></strong>
                        </th>
                    </tr>
            </tbody>
        </table>
